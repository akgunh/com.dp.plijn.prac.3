...
public class AdresDAOPsql implements AdresDAO{
    ...
    public boolean save(Adres adres) {
        try {
            ...
            System.out.println(sqlException + " fout bij opslaan adres!" );;
            return false;
        }
    }
    //update
    ...
    public boolean update(Adres adres) {
        try {
            ...
            System.out.println( sqlException + " fout bij updaten adres!");
            return false;
        }
    }
    //verwijder
    ...
    public boolean delete(Adres adres) {
        try {
            ...
            System.out.println(sqlException + " fout bij deleten adres!");
            return false;
        }
    }
    //vind bij reiziger
    ...
    public Adres findByReiziger(Reiziger reiziger) {
        try {
            ...
            System.out.println(sqlException + " fout bij vinden adres reiziger!");
            return null;
        }
    }
    //vind all
    ...
    public List<Adres> findAll() {
        try {
            ...
            System.out.println(sqlException + " fout bij vind all adres!");
            return null;
        }
    }
}
